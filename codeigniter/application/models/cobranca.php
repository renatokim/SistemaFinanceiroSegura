...
class Cobranca extends CI_Model {
	...
	public function get($dados){ 
		...
		$this->db->where('data_emissao >=', $dados['data_inicial']);
		$this->db->where('data_emissao <=', $dados['data_final']);
		$this->db->where('id_conta_corrente', 17);
