...
$dataini_relat_bco = $_SESSION['dataini_relat_bco'];
$datafin_relat_bco = $_SESSION['datafin_relat_bco'];
...
if (1)
 {
  ...
  /* PRIMEIRA LINHA */
  $resultado = $relatorio->relatbanco($dataini, $datafin);
  ...
  $linha = $relatorio->fetch_array($resultado);
	...
	echo "<FORM METHOD='POST' ACTION=alt_desc_banco.php>
    <TR  bgcolor=$cor>
     ...
     <TD>"; if(isset($_GET['edit']) && $_GET['id']==$id) {
              ...
              echo $descricao;
     echo "</TD>
     <TD ALIGN=CENTER><a href='../contacaixa/contacaixa.php?registro=$id&idconta=$id_conta_corrente&data_emissao=$data_emissao&historico=$historico&doc=$numero_doc&valor=$valor&descricao=$descricao&contacaixa=$conta_caixa&desccontacaixa=$desc_conta_caixa&acao=alterar' TARGET=BLANK
      style='text-decoration:none'>$conta_caixa</TD>
